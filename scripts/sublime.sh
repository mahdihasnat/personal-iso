...
apt-get install -o DPkg::Lock::Timeout=60 -y wget gpg
...
apt-get update
apt-get install -o DPkg::Lock::Timeout=60 -y apt-transport-https
apt-get install -o DPkg::Lock::Timeout=60 -y sublime-text
